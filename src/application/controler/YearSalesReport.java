...
public class YearSalesReport implements Initializable {
...
void btnLoadAction(ActionEvent event) {
	...
	{
		new Alert(AlertType.ERROR,"Select Any Date from").showAndWait();
		return;
	}
	...
	billList.addAll(billService.getYearWiseBills(date.getValue().getYear()));
