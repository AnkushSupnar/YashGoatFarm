...
public class CreateMenuControler implements Initializable {
    ...
    void viewEmployee(ActionEvent event) {
    	PaneViewEmployee = viewUtil.getPage("report/ViewAllEmployee");
    	pane =(BorderPane) createMenuPanel.getParent();
    	
    	pane.setCenter(PaneViewEmployee);
    	PaneViewEmployee.setVisible(true);
    }

    @FXML
    void viewItem(ActionEvent event) {
    	PaneViewItem = viewUtil.getPage("report/ViewAllItems");
    	pane =(BorderPane) createMenuPanel.getParent();
    	pane.setCenter(PaneViewItem);
    	PaneViewItem.setVisible(true);
    }
