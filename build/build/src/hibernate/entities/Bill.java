...
public class Bill {
	...
	public Bill(Customer customer, LocalDate date, double nettotal, double transportingchrges, double otherchargs,
			...
			List<Transaction> transaction,double recivedamount) {
		super();
	...
	public String toString() {
		return "Bill [billno=" + billno + ", customer=" + customer + ", date=" + date + ", nettotal=" + nettotal
				+ ", transportingchrges=" + transportingchrges + ", otherchargs=" + otherchargs 
				+ ", bank=" + bank + ", recievedby=" + recievedby + ", recievedreff=" + recievedreff + ", employee="
				+ employee + ", transaction=" + transaction + ", recivedamount=" + recivedamount + "]";
	}
