...
public class AddEmployeeControler implements Initializable {
	...
	void save(ActionEvent event) {
		try {
			...
			e.setAltermobileno(txtAlternateMobileNo.getText());
			e.setCity(txtCity.getText());
			e.setDistrict(txtDistrict.getText());
			e.setEmail(txtEmail.getText());
			e.setExitdate(dateOfExit.getValue());
			e.setFname(txtFirstName.getText());
			e.setJobpost(cmbJobPost.getValue());
			e.setJoiningdate(dateOfJoin.getValue());
			e.setLname(txtLastName.getText());
			e.setMname(txtMiddleName.getText());
			e.setMobileno(txtMobileNo.getText());
